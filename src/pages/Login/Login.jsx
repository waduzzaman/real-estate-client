    ...
    <>
      ...
      <div className="min-h-screen flex justify-center items-center">
        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content  items-center justify-between w-full lg:w-2/3">
                <div className="text-center lg:text-center bg-emerald-800 text-white flex-1 p-8 lg:py-56 rounded-lg">
